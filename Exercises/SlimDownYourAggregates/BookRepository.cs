...
using SlimDownYourAggregates.Slimmed;
using SlimDownYourAggregates.Slimmed.Entities;

namespace SlimDownYourAggregates;
...
public class ORMBookRepository: IBookRepository
{
    ...
    public void Store(BookEvent @event)
    {
    ...
    ValueTask<BookModel> IBookRepository.Find(BookId id)
    {
        throw new NotImplementedException();
    }
